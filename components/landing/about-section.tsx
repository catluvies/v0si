    ...
    <section id="about" className="relative overflow-hidden">
      <div className="flex items-stretch">
        ...
        <div className="w-full lg:w-1/2 px-8 lg:px-14 py-16 flex flex-col gap-10">
          ...
          >
            <h3 className="text-base font-semibold text-foreground">Nuestra Historia</h3>
          ...
          >
            ...
            <div className="flex flex-col gap-2">
              {['Tecnología Made in Chile', 'Soluciones para entornos extremos', 'Compromiso con la sostenibilidad'].map((item) => (
                <div key={item} className="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-foreground/[0.03] border border-border/30">
          ...
          <motion.div
            ...
            className="flex flex-col gap-4"
          >
            <h3 className="text-base font-semibold text-foreground">Nuestra Visión</h3>
            <p className="text-sm text-foreground/65 leading-relaxed">
